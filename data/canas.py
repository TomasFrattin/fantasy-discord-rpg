CANAS = {
    "cana_rustica": {
        ...
        "descripcion": (
            ...
            "Los peces comunes no desconfían de ella… y eso ya es suficiente 🎣."
        )
    },
    ...
    "cana_reforzada": {
        ...
        "descripcion": (
            ...
            "Empieza a atraer peces más esquivos… aunque aún se resisten 🐟✨."
        )
    },
    ...
    "cana_fina": {
        ...
        "descripcion": (
            ...
            "Los peces raros sienten su llamada… y algunos no pueden ignorarla 🔮🐠."
        )
    },
    ...
    "cana_rúnica": {
        ...
        "descripcion": (
            ...
            "Forjada por magos-pescadores de una era olvidada.\n"
            "Las criaturas épicas reconocen su poder… aunque solo los más valientes logran atraparlas 🐉🌊."
        )
    },
    ...
    "cana_de_raiz_ancestral": {
        ...
        "descripcion": (
            ...
            "Late con energía antigua, viva, indomable.\n"
            "Las leyendas dicen que solo aquellos elegidos por el destino pueden atraer peces legendarios con ella 🐲🌟."
        )
    }
}
